    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'hasattr', 'hash', 'charon_library.hex', 'id', 'input', 'int', 'isinstance',
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'frozenset', 'getattr', 'globals', 'hasattr', 'hash', 'charon_library.hex', 'id',
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'hasattr', 'hash', 'charon_library.hex', 'id', 'input', 'int', 'intern', 'isinstance',
