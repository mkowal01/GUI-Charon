    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'hasattr', 'hash', 'szyfrandodszyfr.hex', 'id', 'input', 'int', 'isinstance',
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'frozenset', 'getattr', 'globals', 'hasattr', 'hash', 'szyfrandodszyfr.hex', 'id',
    ...
    tokens = {
        ...
        'builtins': [
            (words((
                ...
                'hasattr', 'hash', 'szyfrandodszyfr.hex', 'id', 'input', 'int', 'intern', 'isinstance',
