...
class AudioTab2(QWidget):
    def __init__(self, parent=None):
        ...
        self.grid_layout.addWidget(self.text_input, 0, 0, 2, 6)
        ...
        self.grid_layout.addWidget(self.translation_display, 2, 0, 2, 6)
        ...
        self.grid_layout.addWidget(self.language_selector, 4, 0, 1, 2)
        ...
        self.grid_layout.addWidget(self.clear_button, 4, 2, 1, 2)
        ...
        self.grid_layout.addWidget(self.send_button, 4, 4, 1, 2)
